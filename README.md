...
Запуск вышеописанных образов в режиме сервисов в режиме `docker swarm` позволяет поддержать новые возможности:
...
* автоматическая балансировака нагрузки на масшьабированные сервисы.
