...
Для взаимодействия сервисов необходимо создать overlay-сеть. Данная сеть обеспечивает изолирование трафика между сервисами сети 
от внешего доступа и поддерживает внутренний DNS-сервис, обеспечивающий сетевую трансляцию имени сервиса в один или несколько 
внутренних сетевых адресов на которых функционирует сервис.
